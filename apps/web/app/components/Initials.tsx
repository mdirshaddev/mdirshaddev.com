export function Initials() {
  return (
    <svg
      width='1890'
      height='800'
      viewBox='0 0 1890 800'
      fill='none'
      xmlns='http://www.w3.org/2000/svg'
      className='absolute bottom-16 lg:bottom-20 xl:bottom-40 2xl:bottom-60 right-6 md:right-16 xl:right-6 translate-y-[37%] transform-gpu w-[calc(100%-3rem)] md:w-[600px] 2xl:w-[900px] z-[-1] opacity-70 dark:opacity-30'>
      <path
